...
it("expect ship coordinates horizantally calculated", () => {
  const board = new GameBoard();
  expect(board.shipCoordinates("a1", 5)).toStrictEqual(["a1", "a2", "a3", "a4", "a5"])
})

// it("expect gameboard to place ship length five at a1 to fill ship data for a1 through a5", () => {
//   const board = new GameBoard()
//   board.placeShip("a1");
//   expect(board.array).toBe([
